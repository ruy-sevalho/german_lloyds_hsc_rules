...
def panel_bottom_01_exp():
    return ExpPanel(
        name="Bottom Panel 01", pressures={"impact": 23.7413793103448, "sea": 17.5}
    )
...
def panel_bottom_02_exp():
    return ExpPanel(
        name="Bottom Panel 02", pressures={"impact": 26.3793103448276, "sea": 17.5}
    )
...
def panel_bottom_03_exp():
    return ExpPanel(
        name="Bottom Panel 03", pressures={"impact": 17.5862068965517, "sea": 17.5}
    )
